function init()
{
    ...
    enemy1 = new Player("player1", 0xffffff, new THREE.Vector2(50, 0), 0);
...
function Ground(color, size_x, size_y, nb_tile)
{
    ...
    sponColor = Array(0xff0000, 0x00ff00, 0x0000ff);
    ...
    for (x = minX; x <= maxX; x = x+sizeOfTileX){
        for (y = minY; y <= maxY; y = y+sizeOfTileY){
            ...
            if (x == 60 && y == 0) {
                color = sponColor[Math.floor(Math.random() * sponColor.length)];
            }
            else {
